...
Clazz_load(["JS.Symmetry", "JU.P3", "$.SB"], "J.adapter.smarter.XtalSymmetry", ["java.util.HashSet", "$.Hashtable", "JU.A4", "$.BS", "$.Lst", "$.M3", "$.M4", "$.P3i", "$.PT", "$.Quat", "$.V3", "J.adapter.smarter.Atom", "JS.SpaceGroup", "$.SymmetryOperation", "$.UnitCell", "JU.BSUtil", "$.Logger", "$.SimpleUnitCell"], function(){
...
this.spinFrameAxisType = "axisxyz";
var strAxis = this.getSpinExt(spinFrameExt, "axisxyz");
if (strAxis == null) strAxis = this.getSpinExt(spinFrameExt, "axisxyz");
if (strAxis == null) strAxis = this.getSpinExt(spinFrameExt, this.spinFrameAxisType = "perpuvw");
if (strAxis != null) {
var angle = JU.PT.parseFloat(this.getSpinExt(spinFrameExt, "angle"));
...
if (this.spinFrameAxisType.equals("perpuvw")) {
this.perpUVW = axis;
} else {
this.spinFrameRotationMatrix =  new JU.M3().setAA(JU.A4.newVA(axis, (angle * (0.017453292519943295))));
}}}}this.uvwSet =  new java.util.HashSet();
}if (!this.uvwSet.contains(uvw)) {
this.uvwSet.add(uvw);
}return uvw;
}, "~S,~S,~S");
...
this.spinFrameRotationMatrix = this.rotateUVWtoXYZ();
}if (this.spinFrameRotationMatrix != null) {
this.rotateSpinFrameVectors(spinABC);
asc.setCurrentModelInfo("spinFrameRotationMatrix", this.spinFrameRotationMatrix);
...
Clazz_defineMethod(c$, "rotateUVWtoXYZ", 
function(){
...
return JU.Quat.newVA(this.perpUVW, 0).getMatrix();
});
Clazz_defineMethod(c$, "rotateSpinFrameVectors", 
function(spinABC){
var v =  new JU.P3();
for (var i = 4; --i > 0; ) {
v.setT(spinABC[i]);
this.spinFrameRotationMatrix.rotate(v);
this.unitCell.toFractional(v, true);
this.spinFramePp.setColumn4(i - 1, v.x, v.y, v.z, 0);
}
}, "~A");
Clazz_defineMethod(c$, "setSpinVectors", 
function(asc){
...
;//5.0.1-v7 Thu Apr 24 22:44:18 CDT 2025
...
;//5.0.1-v7 Thu Apr 24 22:44:16 CDT 2025
Clazz_declarePackage("JS");
...
;//5.0.1-v7 Thu Apr 24 21:14:52 CDT 2025
Clazz_declarePackage("JS");
...
;//5.0.1-v7 Thu Apr 24 21:38:08 CDT 2025
Clazz_declarePackage("JS");
...
;//5.0.1-v7 Fri Apr 25 08:58:44 CDT 2025
Clazz_declarePackage("JS");
...
;//5.0.1-v7 Thu Apr 24 22:01:45 CDT 2025
Clazz_declarePackage("JS");
