...
Clazz.load(["JS.Symmetry", "JU.P3", "$.SB"], "J.adapter.smarter.XtalSymmetry", ["java.util.HashSet", "$.Hashtable", "JU.A4", "$.BS", "$.Lst", "$.M3", "$.M4", "$.P3i", "$.PT", "$.Quat", "$.V3", "J.adapter.smarter.Atom", "JS.SpaceGroup", "$.SymmetryOperation", "$.UnitCell", "JU.BSUtil", "$.Logger", "$.SimpleUnitCell"], function(){
...
Clazz.defineMethod(c$, "rotateUVWtoXYZ", 
function(){
...
Clazz.defineMethod(c$, "rotateSpinFrameVectors", 
function(spinABC){
var v =  new JU.P3();
for (var i = 4; --i > 0; ) {
v.setT(spinABC[i]);
